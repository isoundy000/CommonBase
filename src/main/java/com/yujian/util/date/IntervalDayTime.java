...
public class IntervalDayTime {
  ...
  public static long toMills(long day,long hour,long minute,long second,long millis){
    try {
      long value = millis;
  ...
  public static long parseMillis(String value){
    ...
    return toMills(days,hours,minutes,seconds,millis) * signum;
  }
